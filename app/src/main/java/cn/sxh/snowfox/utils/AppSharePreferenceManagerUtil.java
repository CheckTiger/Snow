...
public class AppSharePreferenceManagerUtil {
    ...
    public static void putImage(Context mContext, String key, ImageView imageView) {
        ...
        // 将String保存shareUtils
        AppSharePreferenceManagerUtil.put(mContext, key, imgString);
    }
    ...
    public static Bitmap getImage(Context mContext, String key, ImageView imageView) {
        String imgString = (String) AppSharePreferenceManagerUtil.get(mContext, key, "");
        if (!imgString.equals("")) {
            // 利用Base64将我们string转换
